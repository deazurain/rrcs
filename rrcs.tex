...
\item a set of available resources $\mathcal{R}$, split in consumable \TODO{consumable = non-renewable (MickL)} (renewable) resources $\mathcal{R}^{\rho}$ and nonrenewable resources $\mathcal{R}^V$ but with a possible overlap of doubly constrained resources
