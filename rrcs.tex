...
With continuous planning one needs to take into account that the set of tasks is not complete or closed when a schedule is requested, also changes may occur due to unexpected shortage of resources.
...
Because of the growing complexity in the tasks, such as overlap, time constraints en resource constraints, automated planning proves to be less than optimal.
Automated planning does not have the capabilities to take all these extra constraint in to consideration.
