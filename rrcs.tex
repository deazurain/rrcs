...
This scheduling solution is build as to not stress the system with complex scheduling problems, but the narrower options prevent it from giving an optimal solution.\\
