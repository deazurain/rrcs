...
\TODO{schedule, makespan, availability, feasibile schedule}
...
In the running example we can create a time feasible schedule (shown in Figure \ref{fig:time_feasible_schedule}), where the makespan is optimized to a minimum and all the precedence constraints hold.
