...
The distance matrix shows us if their is a time feasible schedule found by the heuristic algorithm.
When there aren't any other numbers then $0$ on the diagonal, the heuristic algorithm has found a time feasible solution.
