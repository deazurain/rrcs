...
In other words, we would like to know if there exists a assignment of start times for all the activities so that the resource requirements and the time requirements are met and the project is finished before the deadline.
