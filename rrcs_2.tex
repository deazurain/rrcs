...
Chapter \ref{text:RCPSP} does name two possible extensions for the interested reader. \TODO{check dit, niet zomaar weghalen deze todo}
...
\TODO{KLOPT NIKS MEER VAN, FIX IK WEL (MICKG)}
