...
\item A set of edges $V_{stn} \subset E_{stn} \times E_{stn}$, where each edge $(t_i, t_j) \in V_{stn}$ represents a precedence constraint and $V_{stn}^-$ is a transitive reduction of $V$. 
\end{itemize}
