...
cleaning the painting brushes&1 hour\\
\end{tabular}
...
In Figure \ref{fig:feasible_schedule} you can see the capacity of the resources, denoted by dotted line, and the usage of resources at a certain time, denoted by the height of the activities in the graph.
...
An exact solution for the RCPSP problem isn't solvable in polynomial time.
